  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        고려대학교 인간-기계 비전 연구실은 인간과 기계의 시각 시스템을 비교 분석하여, 작동 원리와 인지 과정의 차이를 심층적으로 연구하고 있습니다. 심리학과 뇌공학의 융합적 접근 방식을 통해 시각 인지와 관련된 행동 및 신경학적 원리를 탐구하며, 이를 바탕으로 인간 중심의 신뢰할 수 있는 인공지능 모델 개발을 목표로 하고 있습니다. 연구실과의 협력 기회나 팀 일원으로의 참여에 관심이 있다면, 연구 책임자에게 이메일([✉️](contact))로 문의해 주시기 바랍니다. 
    design:
      columns: '1'
      background:
        color: "#FFFFFF"
